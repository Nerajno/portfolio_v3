const speakingData = [
  ...
  },
  {
    ...
    date: "2026-07-23",
    image: "/images/other_images/Speaker_me.jpeg",
    seoDescription: "Nebraska.Code() 2026 – Demonstrating developer competency and confidence, with Nerando Johnson.",
    location: {
      city: "Lincoln",
      state: "Nebraska",
      country: "USA"
  ...
  },
  {
    ...
    date: "2026-05-02",
    seoDescription: "Boise Code Camp 2026 – Master JavaScript fundamentals before diving into modern frameworks with Nerando Johnson's back-to-basics approach.",
    location: {
      city: "Boise",
      state: "Idaho",
      country: "USA"
  ...
  },
  {
    ...
    description: "In the tech industry, we often focus heavily on technical abilities while undervaluing the crucial 'soft skills' that can make or break a developer's career. This talk delves into nine fundamental people skills that are essential for thriving in software engineering, presenting practical, actionable steps for improvement in each area.",
    date: "2026-04-11",
    image: "/images/other_images/Speaker_me.jpeg",
    seoDescription: "Orlando Code Camp 2026 – This is Technical Talk - Essential People Skills for Developers, with Nerando Johnson.",
    location: {
      city: "Sanford",
      state: "Florida",
      country: "USA",
  ...
  },
  {
    ...
    links: {
      ...
      slides: "https://docs.google.com/presentation/d/1mdNezbEijULPhPelJmvDE3AtcvK41SC8jbemL9hPgiI/edit?usp=sharing"
    }
  },
  {
