/* empty css                                 */
import { c as createAstro, a as createComponent, m as maybeRenderHead, s as spreadAttributes, e as addAttribute, f as renderSlot, b as renderTemplate, r as renderComponent, F as Fragment, u as unescapeHTML } from '../chunks/astro/server_BTznwTSM.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                   */
...
const $$Button = createComponent(($$result, $$props, $$slots) => {
  ...
  const styles = {
    outline: "border-2 border-black hover:bg-black text-black hover:text-white dark:border-white dark:hover:bg-white dark:text-white dark:hover:text-black",
    primary: "bg-black text-white hover:bg-slate-900 border-2 border-transparent dark:bg-white dark:text-black dark:hover:bg-slate-200",
    inverted: "bg-white text-black hover:bg-slate-100 border-2 border-transparent dark:bg-black dark:text-white dark:hover:bg-slate-800"
  };
  return renderTemplate`${maybeRenderHead()}<button${spreadAttributes(rest)}${addAttribute([
    "rounded text-center transition focus-visible:ring-2 ring-offset-2 ring-gray-200 dark:ring-gray-700 dark:ring-offset-gray-900",
    block && "w-full",
    sizes[size],
    styles[style],
    className
...
const $$Contactform = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<form action="https://api.web3forms.com/submit" method="POST" id="form" class="needs-validation" data-astro-reload novalidate data-astro-cid-uwnxe3i2> <!-- Add your Web3Forms Access Key --> <input type="hidden" name="access_key" value="1ad33f96-46a7-40aa-b0f0-aa9d6f8f65fa" data-astro-cid-uwnxe3i2> <input type="checkbox" class="hidden" style="display:none" name="botcheck" data-astro-cid-uwnxe3i2> <div class="mb-5" data-astro-cid-uwnxe3i2> <label for="full_name" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1" data-astro-cid-uwnxe3i2>Full Name <span aria-hidden="true" data-astro-cid-uwnxe3i2>*</span></label> <input id="full_name" type="text" placeholder="Name" required autocomplete="name" aria-describedby="name-error" class="w-full px-4 py-3 border placeholder:text-slate-400 rounded-md outline-none focus:ring-4 border-slate-300 focus:border-slate-600 ring-slate-100 dark:text-slate-900 dark:border-slate-700 dark:ring-slate-800 dark:focus:ring-slate-900" name="name" data-astro-cid-uwnxe3i2> <div id="name-error" class="empty-feedback invalid-feedback text-red-400 text-sm mt-1" role="alert" data-astro-cid-uwnxe3i2>\nPlease provide your full name.\n</div> </div> <div class="mb-5" data-astro-cid-uwnxe3i2> <label for="email_address" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1" data-astro-cid-uwnxe3i2>Email Address <span aria-hidden="true" data-astro-cid-uwnxe3i2>*</span></label> <input id="email_address" type="email" placeholder="Email Address" name="email" required autocomplete="email" inputmode="email" aria-describedby="email-error-empty email-error-invalid" class="w-full px-4 py-3 border placeholder:text-slate-400 rounded-md outline-none focus:ring-4 border-slate-300 focus:border-slate-600 ring-slate-100 dark:text-slate-900 dark:border-slate-700 dark:ring-slate-800 dark:focus:ring-slate-900" data-astro-cid-uwnxe3i2> <div id="email-error-empty" class="empty-feedback text-red-400 text-sm mt-1" role="alert" data-astro-cid-uwnxe3i2>\nPlease provide your email address.\n</div> <div id="email-error-invalid" class="invalid-feedback text-red-400 text-sm mt-1" role="alert" data-astro-cid-uwnxe3i2>\nPlease provide a valid email address.\n</div> </div> <div class="mb-3" data-astro-cid-uwnxe3i2> <label for="message" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1" data-astro-cid-uwnxe3i2>Message <span aria-hidden="true" data-astro-cid-uwnxe3i2>*</span></label> <textarea id="message" name="message" required placeholder="Your Message" aria-describedby="message-error" class="w-full px-4 py-3 border placeholder:text-slate-400 rounded-md outline-none h-36 focus:ring-4 border-slate-300 focus:border-slate-600 ring-slate-100 dark:text-slate-900 dark:border-slate-700 dark:ring-slate-800 dark:focus:ring-slate-900" data-astro-cid-uwnxe3i2></textarea> <div id="message-error" class="empty-feedback invalid-feedback text-red-400 text-sm mt-1" role="alert" data-astro-cid-uwnxe3i2>\nPlease enter your message.\n</div> </div> ', ' <div id="result" class="mt-3 text-center" data-astro-cid-uwnxe3i2></div> </form>  <script>\n\n  // use astro:page-load event if you are using View Transitions\n\n  document.addEventListener("DOMContentLoaded", () => {\n\n      const form = document.getElementById("form");\n      const result = document.getElementById("result");\n\n      form.addEventListener("submit", function (e) {\n        e.preventDefault();\n        form.classList.add("was-validated");\n        if (!form.checkValidity()) {\n          form.querySelectorAll(":invalid")[0].focus();\n          return;\n        }\n        const formData = new FormData(form);\n        const object = Object.fromEntries(formData);\n        const json = JSON.stringify(object);\n\n        result.innerHTML = "Sending...";\n\n        fetch("https://api.web3forms.com/submit", {\n          method: "POST",\n          headers: {\n            "Content-Type": "application/json",\n            Accept: "application/json",\n          },\n          body: json,\n        })\n          .then(async (response) => {\n            let json = await response.json();\n            if (response.status == 200) {\n              result.classList.add("text-green-500");\n              result.innerHTML = json.message;\n            } else {\n              console.log(response);\n              result.classList.add("text-red-500");\n              result.innerHTML = json.message;\n            }\n          })\n          .catch((error) => {\n            console.log(error);\n            result.innerHTML = "Something went wrong!";\n          })\n          .then(function () {\n            location.reload(true)\n            form.reset();\n            form.classList.remove("was-validated");\n            setTimeout(() => {\n              result.style.display = "none";\n            }, 5000);\n          });\n      });\n    },\n    { once: true },\n  );\n<\/script>'])), maybeRenderHead(), renderComponent($$result, "Button", $$Button, { "type": "submit", "size": "lg", "block": true, "data-astro-cid-uwnxe3i2": true }, { "default": async ($$result2) => renderTemplate`Send Message` }));
