/* empty css                                 */
import { c as createAstro, a as createComponent, m as maybeRenderHead, e as addAttribute, b as renderTemplate, d as renderScript, r as renderComponent, u as unescapeHTML, F as Fragment } from '../chunks/astro/server_BTznwTSM.mjs';
import 'kleur/colors';
import { $ as $$Layout, b as $$SEO, a as $$Container } from '../chunks/Layout_DBvnNXX8.mjs';
...
const $$Projectcard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300"> <!-- Project Image --> <div class="relative overflow-hidden"> <img${addAttribute(project.image.src || "/placeholder.svg", "src")}${addAttribute(project.image.alt, "alt")} class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300"> <div class="absolute top-3 right-3"> <span class="bg-green-100 text-green-800 text-xs font-medium px-2 py-1 rounded-full"> ${project.status} </span> </div> </div> <!-- Project Content --> <div class="p-4"> <!-- Project Title & Description --> <div class="mb-4"> <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2"> ${project.name} </h3> <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed"> ${project.description} </p> </div> <!-- Tags --> <div class="flex flex-wrap gap-2 mb-4"> ${project.tags.map((tag) => renderTemplate`<span class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-1 rounded text-xs font-medium"> ${tag} </span>`)} </div> <!-- Metrics (if available) -->  <!-- Last Updated -->  <!-- Action Buttons --> <div class="flex gap-2"> ${project.caseStudyUrl && renderTemplate`<a${addAttribute(project.caseStudyUrl, "href")} class="flex-1 bg-blue-700 text-white dark:text-gray-300 text-center py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">
Case Study
</a>`} <a${addAttribute(project.github, "href")} target="_blank" rel="noopener noreferrer" class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-2 px-3 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-1"> <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"> <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"></path> </svg>
Github Repo
</a> ${project.website && renderTemplate`<a${addAttribute(project.website, "href")} target="_blank" rel="noopener noreferrer" class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-2 px-3 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-1"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path> </svg>
Live Version
</a>`} </div> </div> </div>`;
...
const $$Learningprojectcard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300"> <!-- Project Image --> <div class="relative overflow-hidden"> ${project.image && renderTemplate`<img${addAttribute(project.image.src, "src")}${addAttribute(project.image.alt, "alt")} class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300">`} <!-- Growth Status Badge --> ${growthStatus && renderTemplate`<div class="absolute top-3 right-3"> <span${addAttribute(`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${growthStatus.color}`, "class")}> <span class="text-sm">${growthStatus.icon}</span> <span>${growthStatus.label}</span> </span> </div>`} </div> <!-- Project Content --> <div class="p-6"> <!-- Project Title & Description --> <div class="mb-4"> <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2"> ${project.name || project.title} </h3> ${project.description && renderTemplate`<p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed"> ${project.description} </p>`} </div> <!-- Tags --> ${project.tags && renderTemplate`<div class="flex flex-wrap gap-2 mb-4"> ${project.tags.map((tag) => renderTemplate`<span class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-1 rounded text-xs font-medium"> ${tag} </span>`)} </div>`} <!-- Metrics (if available) -->  <!-- Last Updated -->  <!-- Action Buttons --> <div class="flex gap-2 mb-2"> <a${addAttribute(`/learning-projects/${project.id}`, "href")} class="bg-blue-600 dark:bg-blue-800 border border-gray-300 dark:border-gray-600 text-white dark:text-gray-300 py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-700 dark:hover:bg-blue-900 transition-colors flex-1 text-center">
View Details
</a> <!-- {
      ...
      } --> ${project.github && renderTemplate`<a${addAttribute(project.github, "href")} target="_blank" rel="noopener noreferrer" class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-2 px-3 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-1"> <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"> <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"></path> </svg>
Github Repo
</a>`} ${project.demo && renderTemplate`<a${addAttribute(project.demo, "href")} target="_blank" rel="noopener noreferrer" class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-2 px-3 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-1"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path> </svg>
Live Version
...
</p> <div class="flex flex-wrap justify-center gap-4" data-astro-cid-hcjuqwdu> <a href="/contact" class="bg-blue-600 dark:bg-blue-800 text-white dark:text-slate-300 px-6 py-3 rounded-lg font-medium hover:bg-blue-700 dark:hover:bg-blue-900 transition-color" data-astro-cid-hcjuqwdu>
