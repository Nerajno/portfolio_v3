/* empty css                                 */
import { a as createComponent, m as maybeRenderHead, r as renderComponent, u as unescapeHTML, e as addAttribute, b as renderTemplate, c as createAstro, s as spreadAttributes, f as renderSlot } from '../chunks/astro/server_B70G4lE6.mjs';
import 'kleur/colors';
import { c as $$Icon, $ as $$Layout, a as $$Container, b as $$SEO } from '../chunks/Layout_BBkzXZMq.mjs';
import '@astrojs/internal-helpers/path';
import '@astrojs/internal-helpers/remote';
import { a as $$Picture } from '../chunks/_astro_assets_up0hEF2C.mjs';
...
Hi, I am Nerando
</h1> <h2 class="sr-only">Software Developer & Frontend Specialist</h2> <p class="text-medium mt-4 max-w-xl" style="color: var(--text-secondary)" itemprop="description">
...
<span itemprop="knowsAbout">PM and DevOps</span> skills thrown in. Outside of tech, I am a bookworm with a spatula
      among other things.
</p> <div class="mt-6 flex flex-col sm:flex-row gap-3"> ${renderComponent($$result, "Link", $$Link, { "href": "https://garden.developingdvlpr.com/note/crops-growing", "target": "_blank", "rel": "noopener noreferrer", "class": "flex gap-1 items-center justify-center btn-primary", "aria-label": "View what Nerando is currently learning in his digital garden" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Icon", $$Icon, { "class": "w-5 h-5", "name": "bx:bxs-cloud-download", "aria-hidden": "true" })}
Currently Learning
` })} ${renderComponent($$result, "Link", $$Link, { "style": "outline", "href": "https://garden.developingdvlpr.com/note/stuff-building-2025", "target": "_blank", "rel": "noopener noreferrer", "class": "flex gap-1 items-center justify-center btn-secondary", "aria-label": "View what Nerando is currently building in 2025" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Icon", $$Icon, { "class": "w-4 h-4", "name": "bx:bxl-github", "aria-hidden": "true" })}
Currently Building
