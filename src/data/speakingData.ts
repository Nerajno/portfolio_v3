...
export const speakingData: SpeakingEvent[] = [
  ...
  },
  {
    ...
    name: "Demo Name",
    description:
      "Discover techniques to optimize frontend performance for modern web applications. This session will cover strategies to improve load times, reduce render blocking resources, and utilize caching effectively, ensuring faster, smoother user experiences.",
    date: "2025-04-05",
    location: {
      city: "San Francisco",
      state: "CA",
  ...
  },
  {
    ...
    name: "Demo Name",
    description:
      "Tech conferences can feel overwhelming for introverts, but they're essential for career growth and skill development. Learn practical strategies for navigating professional events, from preparing effectively to maximizing networking opportunities while maintaining your energy levels.",
    date: "2024-10-10",
    location: {
      city: "Atlanta",
      state: "GA",
