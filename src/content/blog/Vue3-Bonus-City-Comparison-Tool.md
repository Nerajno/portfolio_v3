---
draft: false
seoTitle: "Bonus: Build a City Comparison Tool — Every Vue 3 Concept in One Project | Nerando Johnson"
seoDescription: "A step-by-step build that deliberately uses every Vue 3 concept from the series — ref, computed, watch, props, events, directives, and component composition — in one cohesive project."
author: "Nerando Johnson"
title: "Bonus: Build a City Comparison Tool — Every Vue 3 Concept in One Project"
snippet: "Instead of showing the finished app and explaining it after, we build it piece by piece and call out exactly which concept we're using at each step. Every concept from Articles 1–6 shows up. Nothing is decoration."
image: {
...
tags: [vue3, javascript, frontend, tutorial, composition-api, project, beginners]
keywords: [Vue 3 project, city comparison Vue, ref computed watch, props events Vue 3, Vue 3 components, v-for v-if Vue, controlled input Vue]
series:
...
schema: {
  type: "TechArticle",
  about: "Building a City Comparison Tool using every Vue 3 concept from the series",
  genre: "Educational Tutorial",
  educationalLevel: "Beginner",
  teaches: ["ref", "computed", "watch", "defineProps", "defineEmits", "v-if", "v-for", "v-model", "v-bind", "Component Composition", "Single Source of Truth"],
  audience: {
...
entities: {
  ...
  secondary: ["ref", "computed", "watch", "defineProps", "defineEmits", "v-for", "v-if", "v-model", "scoped styles"],
  people: ["Evan You"],
  organizations: ["Vue.js Core Team", "Vue School"],
  tools: ["Vue 3", "Vite", "VS Code", "Volar"],
  concepts: ["Props Down Events Up", "Reactive State", "Derived State", "Component Architecture", "Single Source of Truth", "Controlled Input"]
}
---
...
defineProps({
  unit:       { type: String, default: 'F'   },
  warmerSide: { type: String, default: null  },
...
The app is functional with mock data. Here are three exercises to push it further:
...
Replace the mock city data in `App.vue` with a real call to the [Open-Meteo API](https://open-meteo.com/) (free, no key required). Fetch actual temperature and condition data for any city name entered.
...
*Sources: [Vue.js Official Docs](https://vuejs.org/guide/introduction) · [Vue School](https://vueschool.io/articles) · [Vue.js Reactivity Fundamentals](https://vuejs.org/guide/essentials/reactivity-fundamentals)*
