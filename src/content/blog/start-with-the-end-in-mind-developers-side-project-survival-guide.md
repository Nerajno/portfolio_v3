...
# ============================================================================
# SEO KEYWORDS (For traditional search ranking)
# ============================================================================
keywords: [
...
# ============================================================================
# GEO OPTIMIZATION (Generative AI: ChatGPT, Claude, Gemini, Perplexity)
# ============================================================================
geo: {
    ...
    audience: {
        ...
        painPoints: ["too many unfinished projects", "scope creep", "lack of motivation", "unclear goals"],
        goals: ["ship completed projects", "build portfolio", "learn new technologies while finishing"]
    },
...
#     alt: "Custom Open Graph image description"
# }
# Optional: Canonical URL (use if republishing content)
# canonical: "https://original-source.com/article"
# Optional: No index (use if you don't want search engines to index)
# noindex: false
---

### The Universal Developer's Dilemma

![](https://i.redd.it/lxxvnzk1d9j61.jpg)
...
The difference between developers who ship and those who eternally tinker lies not in their technical abilities or available time, but in their ability to define completion before writing a single line of code. Most of us approach side projects like we're building for a Fortune 500 company, architecting for millions of users who will never come, optimizing for scale we'll never need, and adding features for edge cases that exist only in our imagination. This isn't strategic planning—it's perfectionism wearing the disguise of professionalism, and it's the silent killer of more projects than all technical debt combined. Before touching your keyboard, you must create what I call a "Done Contract" with yourself, explicitly stating what features constitute a shippable version 1.0 and, more importantly, what features absolutely do not. This contract becomes your North Star when scope creep whispers sweet nothings about "just one more feature" at 2 AM, providing the clarity and boundaries that transform endless projects into shipped products.
...
The Kill List Framework isn't just another prioritization exercise—it's a structured approach to murdering your darlings before they murder your project's chances of completion. Start with a 15-minute brain dump where you write down every feature you've imagined for your project, including the realistic, the ambitious, and the absolutely absurd—this is your "everything list" that represents your unconstrained vision. Next comes the brutal categorization that separates dreamers from shippers: MUST-HAVE features (maximum 3) that represent the absolute core without which your project has no reason to exist, SHOULD-HAVE features (maximum 5) that enhance the experience but aren't required for launch, COULD-HAVE features that sound great but will delay your launch by months, and WON'T-HAVE features that you explicitly reject and document to prevent their resurrection. For example, when I built my markdown note-taking app, my original feature list included real-time collaboration, AI-powered suggestions, mobile apps, plugin systems, themes, and team workspaces—but my Kill List reduced this to just three must-haves: create and edit markdown files, preview rendered markdown, and save files locally. Every Sunday at 2 PM, I perform a 15-minute Kill List audit, checking if any features tried to sneak back in, whether I added scope that wasn't on the MUST-HAVE list, and updating the "Last Updated" date to create accountability with myself.
...
Time constraints breed creativity and prevent gold-plating, which is why I've adopted a strict 30-day sprint structure that forces completion decisions rather than endless deliberation. Week 1 focuses on setup and your first core feature: days 1-2 for project setup and architecture decisions, days 3-7 for building MUST-HAVE feature #1 completely without any polish or optimization. Week 2 tackles the remaining core features with similar intensity: days 8-11 for MUST-HAVE feature #2, days 12-14 for MUST-HAVE feature #3, with no deviations or "quick additions" allowed. Week 3 brings everything together: days 15-17 for connecting all features and fixing only integration bugs, days 18-21 for minimal UI polish and basic error handling that prevents crashes but doesn't handle every edge case. Week 4 is your launch sequence: days 22-25 for writing documentation and testing with one real user who isn't you, days 26-28 for deployment and fixing only critical bugs, day 29 for soft launch to friends or community, and day 30 for public announcement regardless of your comfort level with the current state. If you slip behind schedule, you cut the most recent feature, not the deadline—the launch date is sacred while features remain negotiable, because a shipped imperfect project beats a perfect project that exists only in your head.
...
Projects with defined milestones and celebration rituals are 4x more likely to reach completion because our brains are wired for immediate gratification, while side projects by nature delay gratification for weeks or months—you need to hack this biological system. I maintain a "Done Diary" where I log every coding session's accomplishments no matter how small: "Fixed the CSS bug" counts, "Refactored the authentication flow" counts, and even "Spent 30 minutes and made everything worse" counts because showing up is half the battle. For public accountability, I share progress openly even when it's embarrassing, posting screenshots of half-broken UI on Twitter with #buildinpublic, writing weekly Dev.to posts about challenges faced, and joining Discord communities where other builders share their struggles and wins. My milestone reward system is deliberately excessive: completing a feature earns my favorite coffee, finishing the MVP unlocks that mechanical keyboard I've been eyeing, beta launch justifies takeout from the expensive place, and public launch demands a meaningful celebration like a nice dinner or weekend trip. These aren't frivolous expenses or time-wasters—they're psychological anchors that train your brain to associate project progress with positive outcomes, creating a dopamine feedback loop that pulls you through the brutal middle phase where most projects die.
...
Your energy, not time, is the limiting resource in side project completion, yet most developers completely ignore this reality when scheduling their work sessions. I spent a week tracking my energy levels at different times (9-11 AM, 2-4 PM, 7-9 PM) and discovered my peak hours were completely different from when I had been trying to code, which explained why every session felt like pushing a boulder uphill. High-energy tasks like architectural decisions, complex algorithm implementation, learning new technology, and debugging gnarly bugs now get scheduled during peak hours only, while medium-energy tasks like implementing planned features, writing tests, and refactoring fill the normal hours. Low-energy periods aren't wasted—they're perfect for code formatting, updating dependencies, organizing files, reading documentation, and planning the next session's work, tasks that still move the project forward without requiring deep focus. I've also identified and eliminated energy drains: decision fatigue (make all tool/stack decisions in week one), context switching (Slack and email are completely off during work sessions), perfectionism (when the timer goes off, I commit the code as-is), comparison (unfollowed all those 10x developers on Twitter), and negative self-talk (I keep a "Past Wins" document that I read when imposter syndrome strikes). This energy-aware approach has tripled my effective productivity without adding a single hour to my schedule.

### The Boring Tech Principle: Choose Stability Over Novelty
...
Use the most boring, proven technology that solves your problem, because your side project is not the place to learn Rust, WebAssembly, and a new database simultaneously while also building something you want to ship. My boring tech stack has become predictable and powerful: Express.js for backend because it just works, React with Create React App for frontend because the ecosystem is mature, PostgreSQL for data because it handles everything, Vercel for deployment because it's literally three clicks, and Tailwind CSS for styling because I can build interfaces without thinking about class names. I explicitly avoid bleeding-edge frameworks that might break next month, custom build tools that require configuration gymnastics, microservices when a monolith would work perfectly, complex state management when useState is sufficient, and especially rolling my own authentication when Auth0 exists. The "Boring Tech Test" is simple but effective: if you abandon this project for three months, can you return and immediately understand what's happening without reading documentation or remembering complex setup? If the answer is no, you're using too much novel technology, and every moment spent learning new tools is a moment not spent shipping your actual project—save the learning projects for when learning is the explicit goal, not when shipping is what matters.
...
### Your Next Move: The Developer's Action Plan
![](https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExbmxkcmxzbjR5eHBhMHl4OWN1MjI1eGZmZG52c2hkeDJkcGp4NWpraiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/2FVkVe9q2Rg5i/giphy.gif)

**Stop reading. Start shipping. Here's exactly what to do:**

### Right Now (Next 5 Minutes):
- [ ] Close all browser tabs except this one
- [ ] Create a new file: `KILL_LIST.md` in your current project or new folder
- [ ] Write down THREE features maximum for your MVP
- [ ] Set a timer for 20 minutes
- [ ] Start coding the first feature—no setup, no planning, just build

### Today (Within 24 Hours):
- [ ] Choose ONE project from your graveyard—the simplest one, not the coolest
- [ ] Delete or archive all other unfinished projects to remove temptation
- [ ] Set your launch date exactly 30 days from today
- [ ] Tell one person about your project and deadline
- [ ] Make your first commit, even if it's just a README

### This Week (Days 1-7):
- [ ] **Day 1:** Write your Kill List and Definition of Done (2 hours max)
- [ ] **Day 2:** Set up with boring tech only—no new frameworks
- [ ] **Day 3-5:** Build ONE complete feature, no polish allowed
- [ ] **Day 6:** Share your progress publicly somewhere (Twitter, Dev.to, Discord)
- [ ] **Day 7:** Schedule your Sunday 2 PM negotiation checkpoint

### Your 30-Day Shipping Commitment:

**Week 1:** Foundation
- Build your 3 MUST-HAVE features
- No optimization, no refactoring
- Daily commits, broken code is fine
- Share one ugly screenshot
...
**Week 4:** Ship It
- Feature freeze on Day 22
- Deploy by Day 28
- Announce on Day 30
- Celebrate regardless of response
...
- [ ] Promise your rubber duck—but make it public
- [ ] Start a simple dev log in a `PROGRESS.md` file
- [ ] Use a habit tracker app specifically for this project
- [ ] Block your favorite time-wasting site until you ship

### If You're a Beginner:
- Your first project should take 7 days, not 30
- Pick something embarrassingly simple (seriously, simpler than that)
- Success looks like: it works on your computer
- Skip authentication, databases, and deployment complexity
- A working to-do list beats an imagined SaaS
...
1. **No new features** after Day 7—only refinement
2. **No rewrites** because you learned a "better way"
3. **No asking for permission** to ship imperfect work
4. **No waiting** for the perfect launch opportunity
5. **No apologizing** for your project's limitations

### Make This Pledge (Out Loud):
*"I will ship something in 30 days. It will be imperfect. It will be useful to at least one person. That person might just be me. That's enough."*

**Final Challenge:** Screenshot this action plan right now. Make it your desktop wallpaper for the next 30 days. Every time you see it, either work on your project or forgive yourself for not working—but never forget your commitment to ship.

**P.S.** - Want accountability? Reply to this article or tweet at me with your Kill List and launch date. Use #KillListFramework and I'll check in on Day 15 and Day 30. Let's turn that project graveyard into a project portfolio. Together.

## Quick Reference: The Shipping Mantras

- "Three features, three weeks, then ship"
- "Done diary daily, scope review Sunday"
- "If it's not on the Kill List, it's not in the code"
- "48 hours to recover, not to stall"
- "Boring tech wins; shiny tech delays"
- "Build in public; shame in private"
- "Launch imperfect; iterate in public"
- "Finished beats perfect; shipped beats planned"

*Remember: The world needs your imperfect, shipped solution more than it needs your perfect, imagined one. Now close this article and open your editor. Your future self—the one with a shipped project—is waiting.*

---

### Resources Referenced

- [6 Tips to Finish Your Side Project](https://thomas-sojka.tech/6-tips-to-finish-your-side-project.html)
- [Simple Programmer's Guide to Side Projects](https://simpleprogrammer.com/guide-side-projects/)
- [Definitive Guide to Finishing Side Projects](https://dev.to/jaimelr/the-definitive-guide-to-finally-finish-your-side-projects-533g)
- [Developer Side Projects: 10 Steps from Creation to Launch](https://thevaluable.dev/side-project-successful/)
- [Leveling Up Through Side Projects](https://betterprogramming.pub/leveling-up-through-side-projects-in-software-engineering-3d2d7aff8c45)
