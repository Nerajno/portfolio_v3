---
draft: false
seoTitle: "People Skills Are Technical Skills (And I Can Prove It) | Nerando Johnson"
seoDescription: "Communication, adaptability, leadership — we've been calling these soft skills, but they meet every bar we use to define a technical skill. A framework for the 7 people skills most critical to your career as a developer."
author: "Nerando Johnson"
title: "People Skills Are Technical Skills (And I Can Prove It)"
snippet: "67% of failed software projects trace back to interpersonal breakdowns — not technical failures. Yet we still call communication a 'soft skill' and leave it off our personal development roadmaps. This article builds the case that people skills are technical skills by definition, then gives you a practical framework for the 7 tenets that will determine how far your career actually goes."
image: {
  src: "https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg",
  alt: "Team of developers collaborating around a whiteboard with sticky notes"
}
...
schema: {
  type: "Article",
  about: "Reframing people skills as technical skills for software developers with a 7-tenet practical framework",
  genre: "Career Development Guide",
  educationalLevel: "Beginner to Senior",
  teaches: ["Communication", "Interpersonal Skills", "Problem Solving", "Time Management", "Adaptability", "Attention to Detail", "Leadership"],
  audience: {
...
entities: {
  primary: ["People Skills", "Technical Skills", "Career Development", "Developer Communication"],
  secondary: ["Soft Skills", "Leadership", "Adaptability", "Time Management"],
  tools: ["Slack", "Pull Requests", "Sprint Planning", "Retrospectives", "Code Reviews"],
  concepts: ["Communication", "Interpersonal Skills", "Problem Solving", "Time Management", "Adaptability", "Attention to Detail", "Leadership", "Deliberate Practice", "Psychological Safety"]
}

contentStructure: {
  type: "Framework Article",
  difficulty: "Beginner to Intermediate",
  timeToComplete: "16-20 minutes read",
  prerequisites: ["Some experience working on a software team (helpful but not required)"],
  outcomes: ["Understand why people skills meet the definition of technical skills", "Learn the 7 tenets framework for developer people skills", "Identify which tenet to prioritize on your personal development roadmap", "Take one concrete action this week toward a specific skill"]
}

semanticContext: {
  topic: "People skills as technical skills for software developers",
  subtopics: ["Communication in Engineering", "Interpersonal Dynamics on Dev Teams", "Problem Solving Collaboration", "Developer Time Management", "Engineering Adaptability", "Code Review Attention to Detail", "Technical Leadership"],
  relatedConcepts: ["Career Growth", "Soft Skills Reframing", "Developer Effectiveness", "Team Dynamics", "Engineering Culture"],
  practicalApplication: true
}

citationMetadata: {
  citableAs: "Johnson, N. (2026). People Skills Are Technical Skills (And I Can Prove It)",
...
aiOptimization: {
  summaryPrompt: "This article argues that people skills meet every definitional bar of a technical skill — specialized knowledge, deliberate practice, measurable outcomes, real-world application — then provides a 7-tenet framework (Communication, Interpersonal Skills, Problem Solving, Time Management, Adaptability, Attention to Detail, Leadership) with wrong/right/better breakdowns for each",
  keyTakeaways: [
    "67% of failed software projects trace back to interpersonal breakdowns, not technical failures",
    "A technical skill is specialized knowledge that improves with practice, produces measurable outcomes, and gets tested in real-world conditions — people skills clear every bar",
    "The soft/hard distinction describes our discomfort with studying people skills, not the nature of the skills themselves",
    "Each of the 7 tenets has a wrong, right, and better version — knowing where you fall is the first step",
    "Junior developers who communicate well get promoted faster and get better mentorship — the path is never just technical"
  ],
  technicalDepth: "low",
  codeExamples: false
}
...
![Loading screen — 7 skills incoming](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExcDYzdXVuNzlia2YwM3Q2OWh5c2N3aDZ2ZXg3dGM0dGhlcWZxeTJjYSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/cZskL3prfU4hwZI4l9/giphy.gif)
...
![Myth-busting time](https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExNncxeGdscnN2YW8yYjR3ZTV3NjFyYXV1ajgwdHAyemo1dzMwdHBnaCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/Y1L0dHsQrUpkv8Org7/giphy.gif)

**Myth:** Soft skills are personality traits — you either have them or you don't.
**Reality:** Every tenet on this list is learnable, trainable, and measurable. You're not born knowing how to give effective feedback any more than you're born knowing how to debug a race condition.

**Myth:** Technical skills are hard. People skills are easy.
**Reality:** Conflict resolution under deadline pressure is one of the hardest things you will ever do in an engineering career. Communication across a power differential is hard. Leading without authority is hard. The difficulty isn't the argument — it's that we've been treating these as optional.

**Myth:** This stuff isn't relevant until you're senior.
**Reality:** Junior developers who communicate well get promoted faster and get better mentorship. The path from junior to mid to senior is not just technical. It's almost never just technical. The people who figured that out early are the ones you look at and wonder why they keep advancing.

---

## What You Can Do This Week

![Okay but make it actionable](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExb2FuZDZrazloNGcyOXJlN3FheWhrMXM2OWFubXNzamo5YXVzb25tdSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/BR7HRergdgkTQd5ElL/giphy.gif)
...
![Mic drop — but measured, because we're engineers](https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExNTN2NTI0bW5sMzllZzZjdDNmdnczc3JpMm56eHpicHludmc4aW1jMSZlcD12MV9pbnRlbmFsX2dpZl9ieV9pZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/H1YMguVrVeI0Xz5c8v/giphy.gif)
